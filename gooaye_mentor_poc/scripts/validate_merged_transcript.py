...
from common import DATA, REPORTS, path_for_report, write_json
...
def main() -> int:
    ...
    print(json.dumps({"status": status, "json": path_for_report(json_path), "report": path_for_report(report_path)}, ensure_ascii=False, indent=2))
