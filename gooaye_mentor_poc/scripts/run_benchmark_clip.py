...
from common import CONFIG, path_for_report, setup_logging, sha256_file, write_json
from transcribe_episode import CONFIGS, VramMonitor, pkg, srt_time
...
def main() -> int:
    ...
    prompt = (CONFIG / "terminology.txt").read_text(encoding="utf-8")
